...
$(obj).target/dsa-native.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(obj).target/dsa-native.node: LIBS := $(LIBS)
$(obj).target/dsa-native.node: TOOLSET := $(TOOLSET)
$(obj).target/dsa-native.node: $(OBJS) $(obj).target/node_modules/node-addon-api/src/nothing.a FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(obj).target/dsa-native.node
# Add target alias
.PHONY: dsa-native
dsa-native: $(builddir)/dsa-native.node

# Copy this to the executable output path.
$(builddir)/dsa-native.node: TOOLSET := $(TOOLSET)
$(builddir)/dsa-native.node: $(obj).target/dsa-native.node FORCE_DO_CMD
	$(call do_cmd,copy)

all_deps += $(builddir)/dsa-native.node
# Short alias for building this executable.
.PHONY: dsa-native.node
dsa-native.node: $(obj).target/dsa-native.node $(builddir)/dsa-native.node

# Add executable to "all" target.
.PHONY: all
all: $(builddir)/dsa-native.node
